        ...
        for (String line : lines) {
            try {
                ...
                switch (string0_split[0]) {
                    ...
                    case "particles": options.particles = ParticlesMode.byId(Integer.parseInt(strings[1])); break;
                    ...
                    case "ao": options.ao = AoMode.byId(Integer.parseInt(strings[1])); break;
                    ...
                    case "lang":
                        ...
                        options.language = client.getLanguageManager().getLanguage().getCode(); break;
                    ...
                    case "narrator": options.narrator = NarratorMode.byId(Integer.parseInt(strings[1])); break;
                    ...
                    case "perspective": options.setPerspective(Perspective.values()[Integer.parseInt(strings[1]) % 3]); break;
                    case "piedirectory":
