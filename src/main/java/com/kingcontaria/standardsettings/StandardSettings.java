...
public class StandardSettings {
    ...
    private static final Window window = client.window;
    ...
    public static String getStandardoptionsTxt() {
        ...
        string.append("chunkborders:").append(l).append("hitboxes:").append(l).append("perspective:").append(l).append("f1:").append(l).append("fovOnWorldJoin:").append(l).append("guiScaleOnWorldJoin:").append(l).append("renderDistanceOnWorldJoin:").append(l).append("changeOnResize:false").append(l).append("f3PauseOnWorldLoad:false").append(l).append("firstWorldF3PauseDelay:22");
